...
<div class="content-wrapper">
    ...
    <input type="text" class="form-control" id="ProductName" name="product_name" aria-describedby="emailHelp" value="{{ $pdata->name }}">
   
  </div>
  <div class="form-group">
    <label for="ProductId">Product Id</label>
    <input type="text" class="form-control" id="ProductId" name="product_id" value="{{ $pdata->product_id}}">
  </div>

  <div class="form-group">
    <label for="Description">Description</label>
    <textarea class="form-control" id="Description" name="product_description" rows="3" >{{ $pdata->description}}</textarea>
  </div>
  <img src="{{ asset("product_images/".$pdata->image)}}" alt="" style="width:200px;height:200px;">
  <div class="form-group">
   
    <label for="image">Image</label>
    
    <input type="file" class="form-control-file" id="Product image" name="product_image" >
  </div>

  <div class="form-group">
    <label for="VideoLink1">Video Link 1(product video)</label>
    <input type="link" class="form-control" id="Vlink1" name="Video_link1" value="{{ $pdata->vlink1}}">
  </div>

  <div class="form-group">
    <label for="VideoLink2">Video Link 2(How To Coock)</label>
    <input type="link" class="form-control" id="Vlink2" name="Video_link2" value="{{ $pdata->vlink2}}">
  </div>

  
  <div class="form-group">
    <label for="price">Product Price</label>
    <input type="text" class="form-control" id="p_price" name="product_price" value="{{ $pdata->price}}">
  </div>

  <div class="form-group">
    <label for="Discount">Product Discount</label>
    <br>
    <input type="text" class="form-control" id="p_discount" name="product_discount" value="{{ $pdata->discount}}" style="display:inline; width:68%">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="p_quantity" name="product_quantity" value="{{ $pdata->quantity}}"  style="width:50%">
  </div>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="d_cat" name="categery">
      ...
      @php ($i = 1)
      <option id= "{{"cat".$i++ }}" value="{{ $item->cat_id }}"> {{ $item->name }}</option>
      @endforeach
